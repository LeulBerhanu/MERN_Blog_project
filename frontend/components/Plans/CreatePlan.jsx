...
import { createPlanAPI } from "../../src/APIServices/plan/planAPI";
...
const CreatePlan = () => {
  ...
  // console.log("planMutation", planMutation);
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        {planMutation.isSuccess && (
          <AlertMessage type="success" message="Plan created in successfully" />
        )}
